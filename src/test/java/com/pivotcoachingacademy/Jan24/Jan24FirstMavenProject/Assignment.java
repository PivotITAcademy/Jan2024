...
public class Assignment {
	...
	private static final String EDGE_DRIVER_PATH = "C:\\\\Users\\\\Owner\\\\Downloads\\\\edgedriver_win64 (4)\\\\msedgedriver.exe";
	...
	private void viewCartAndCheckout() {
		...
		WebElement shoppingCartBtn=wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//div[contains(@class, 'alert-success')]/a[contains(@href, 'route=checkout/cart')]")));
		//Move the focus point to the element
		action.moveToElement(shoppingCartBtn).perform();
		shoppingCartBtn.click();

		WebElement checkoutBtn=wait.until(ExpectedConditions.elementToBeClickable(
				By.cssSelector("div.pull-right a.btn[href*='route=checkout/checkout']")));
		checkoutBtn.click();
	}
